final class OSMView: UIView {
  ...
  private func layoutViews() {
    ...
    NSLayoutConstraint.activate([
      OSMImageView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20),
      ...
      OSMTextLabel.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20),
  ...
  private func attributedString(for date: String) -> NSAttributedString {
    ...
    let attributedString = NSMutableAttributedString(string: String(format: L("osm_presentation"), date.trimmingCharacters(in: .punctuationCharacters), osmLink),
