final class AboutController: MWMViewController {
  ...
  private enum Constants {
    ...
    static let socialMediaCollectionViewCellHeight: CGFloat = 40
    ...
    static let socialMediaCollectionViewContentInset = UIEdgeInsets(top: 0, left: 20, bottom: 0, right: 20)
  }
  ...
  private let additionalInfoView = AdditionalInfoStackView()
...
private extension AboutController {
  func setupViews() {
    ...
    headerTitleLabel.setStyleAndApply("regular18:blackPrimaryText")
    ...
    additionalInfoView.addItem(image: UIImage(named: "ic_no_tracking")!, text: L("about_proposition_1"))
    additionalInfoView.addItem(image: UIImage(named: "ic_no_wifi")!, text: L("about_proposition_2"))
    additionalInfoView.addItem(image: UIImage(named: "ic_community")!, text: L("about_proposition_3"))
  ...
  func arrangeViews() {
    ...
    stackView.addArrangedSubviewWithSeparator(additionalInfoView)
    if isDonateEnabled() {
  ...
  func layoutViews() {
    ...
    NSLayoutConstraint.activate([
      ...
      additionalInfoView.widthAnchor.constraint(equalTo: stackView.widthAnchor),
      ...
      socialMediaHeaderLabel.leadingAnchor.constraint(equalTo: socialMediaCollectionView.leadingAnchor, constant: Constants.socialMediaCollectionViewContentInset.left),
  ...
  func buildInfoTableViewData() -> [AboutInfoTableViewCellModel] {
    let data = AboutInfo.allCases.map { [weak self] aboutInfo in
      return AboutInfoTableViewCellModel(title: aboutInfo.title, image: aboutInfo.image, didTapHandler: {
        ...
        case .reportABug:
          guard let link = aboutInfo.link else { return }
  ...
  func buildSocialMediaCollectionViewData() -> [SocialMediaCollectionViewCellModel] {
    let data = SocialMedia.allCases.map { [weak self] socialMedia in
      return SocialMediaCollectionViewCellModel(image: socialMedia.image, didTapHandler: {
        ...
        case .organicMapsEmail:
          guard let link = socialMedia.link else { return }
...
extension AboutController: UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    cell.set(title: aboutInfo.title, image: aboutInfo.image)
    return cell
  }
}
...
extension AboutController: UICollectionViewDelegateFlowLayout {
  func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
    ...
    let totalInsets = Constants.socialMediaCollectionViewContentInset.left + Constants.socialMediaCollectionViewContentInset.right
    var totalSpacing = (Constants.socialMediaCollectionNumberOfItemsInRowCompact - 1) * spacing
    var width = (collectionView.bounds.width - totalSpacing - totalInsets) / numberOfItemsInRowCompact
    if traitCollection.verticalSizeClass == .compact || traitCollection.horizontalSizeClass == .regular {
      ...
      width = (collectionView.bounds.width - totalSpacing - totalInsets) / numberOfItemsInRowRegular
    }
    return CGSize(width: width, height: width)
  }

  func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
    return Constants.socialMediaCollectionViewContentInset
  }
